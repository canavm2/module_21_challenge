...
Successful compile of the KaseiCoin Contract
![SuccessfulCompile](SuccessfulCompile.PNG)

Successful compile of the KaseiCoinCrowdsale Contract
![SuccessfulCompileCS](SuccessfulCompileCS.PNG)

Successful compile of the KaseiCoinDeployer Contract
It's the saem file as above, but you can see the deployer code visible.
![SuccessfulCompileCS2](SuccessfulCompileCS.PNG)

Deployed Crowdsale
The Deployer and the Crowdsale Contracts Deployed
![DeployedContracts](DeployedContracts.PNG)

The Ganache Transactions
![GanacheTransactions](GanacheTransactions.PNG)

Crowdsale Receipts
![CrowdsaleReceipts](CrowdsaleReceipts.PNG)

Total Supply
![TotalSupply](TotalSupply.PNG)

Wei Raised
![WeiRaised](WeiRaised.PNG)